...
public class CountByManufacturer extends AbstractCommand implements Serializable {
    ...
    public void execute(Object o, DatagramSocket datagramSocket, DatagramPacket datagramPacket) throws IOException {
        ...
        Logging.log(Level.INFO, "Server is executing countByManufacturer command....");
        receiver.countByManufacturer((String) o);
    }
}