...
public class FilterContainsName extends AbstractCommand implements Serializable {
    ...
    public void execute(Object o, DatagramSocket datagramSocket, DatagramPacket datagramPacket) throws IOException {
        ...
        Logging.log(Level.INFO, "Server is executing filterContainName command....");
        receiver.filterContainsName((String) o);
    }
}
