...
public class Commander {
    ...
    private boolean categorizeCommand(String[] userCommand) {
        switch (userCommand[0]) {
            ...
            case "add_if_min":
                if(userCommand.length == 1){
                    return !commandManager.addIfMin();
                }
                System.out.println("This command doesn't support argument!");
                return true;
            ...
            case "count_by_manufacturer":
                if(userCommand.length == 2){
                    return !commandManager.countByManufacturer(userCommand[1]);
                }
            ...
            case "filter_contains_name":
                if(userCommand.length == 2){
                    return !commandManager.filterContainsName(userCommand[1]);
                }
            ...
            case "print":
                if(userCommand.length == 1){
                    return !commandManager.printFieldDescendingManufacturer();
                }
                System.out.println("This command doesn't support argument!");
                return true;
